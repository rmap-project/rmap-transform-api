...
/**
 * Tests for RMapApiException
 */
public class RMapApiExceptionMapperTest {

	/**
	 * Test RMap Exception message for transform type not found
	 */
	@Test	
	public void testExceptionMessage() {
		
		RMapTransformApiException e = new RMapTransformApiException(ErrorCode.ER_CANNOT_FIND_TRANSFORM_TYPE);
		RMapTransformApiExceptionHandler mapper = new RMapTransformApiExceptionHandler();
